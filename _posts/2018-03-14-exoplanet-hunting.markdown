...
{% include image.html url="/assets/images/exoplanets/light_orbit.png" description="Planet orbiting a star lowers light intensity (source: Kaggle)" %}
...
{% include image.html url="/assets/images/exoplanets/light_flux.png" description="Light flux for confirmed Non-Exoplanet (index 150) on the left and confirmed Exoplanet (index 4) on the right." %}
...
{% include image.html url="/assets/images/exoplanets/confusion_matrix.png" description="Confusion Matrix: Recall-> Out of all the actual positive examples, how many did we predict to be positive? Precision-> Out of the predicted positive examples, how many were actually positive?" %}
...
{% include image.html url="/assets/images/exoplanets/fourier.png" description="Example of a signal (top yellow) and the decomposed original pure frequencies that make it up (source: 3Blue1Brown)" %}
...
{% include image.html url="/assets/images/exoplanets/light_flux_2.png" description="Light flux over time gathered by Kepler Telescope. Non-Exoplanet (index 150) on the left, Exoplanet (index 4) on the right." %}

{% include image.html url="/assets/images/exoplanets/results_unprocessed_data.png" description="Out of the 5 confirmed Exoplanets in the Dev Set, we correctly predicted 3 to be Exoplanets and incorrectly predicted 2 to not be an Exoplanets" %}
...
{% include image.html url="/assets/images/exoplanets/results_smote.png" description="Out of the 5 confirmed Exoplanets in the Dev Set, we correctly predicted 3 to be Exoplanets and incorrectly predicted 2 to not be an Exoplanets" %}
...
{% include image.html url="/assets/images/exoplanets/light_flux_gaussian.png" description="Light flux levels after processing via normalizing, standardizing, and applying a gaussian filter for smoothing. Non-Exoplanet on the left, Exoplanet on the right." %}

{% include image.html url="/assets/images/exoplanets/results_gaussian.png" description="Out of the 5 confirmed Exoplanets in the Dev Set, we correctly predicted 4 to be Exoplanets and incorrectly predicted 1 to not be an Exoplanet" %}
...
{% include image.html url="/assets/images/exoplanets/light_flux_fourier.png" description="The Fourier Transform results in a new function, a function of frequency instead of time, giving us the frequencies that make up the original signal. Non-Exoplanet on the left, Exoplanet on the right." %}

{% include image.html url="/assets/images/exoplanets/results_fourier.png" description="Out of the 5 confirmed Exoplanets in the Dev Set, we correctly predicted all 5 to be Exoplanets. However we also had 7 false positives, meaning we predicted them to be Exoplanets but they weren’t." %}
...
{% include image.html url="/assets/images/exoplanets/results_without_smote.png" description="Out of the 5 confirmed Exoplanets in the Dev Set, we correctly predicted all 5 to be Exoplanets. In this case, our Train set was predicted perfectly as we had all True Positives and True Negatives in the Confusion Matrix." %}
...
**Kaggle** (please [upvote][upvote]{:target="_blank"} on top tight corner!): [Kaggle Kernel][kaggle-kernel]{:target="_blank"}

**Full source code:** [https://github.com/gabrielgarza/exoplanet-deep-learning][github-repo]{:target="_blank"}
